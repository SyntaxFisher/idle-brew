...
- `make` is the whole toolchain: `make` builds, bundles, ad-hoc signs, installs to `~/Applications`, and launches. Other targets: `bundle`, `clean-legacy`, `reset-tcc`, `uninstall`, `clean`.
